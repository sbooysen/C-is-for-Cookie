...
// We create the tile layer that will be the primary background of our map.
...
// We create a second tile layer that will be an optional background of our map.
...
// We create a third tile layer that will be an optional background of our map.
...
// DELIVERABLE 3 ADDED NEW TILE LAYER TO BASE
let baseMaps = {
  "Streets": streets,
...
// DELIVERABLE 1 - Step 1: Add a 2nd layer group for the tectonic plate data.
// DELIVERABLE 2 - Step 1: Add a 3rd layer group for the major earthquake data.
let cookiesales = new L.LayerGroup();
let girlcount = new L.LayerGroup();
let donations = new L.LayerGroup();

// DELIVERABLE 1 - Step 2: Add a reference to the tectonic plates group to the overlays object.
// DELIVERABLE 2 - Step 2: Add a reference to the major earthquake group to the overlays object.
let overlays = {
  "Overall Sales": cookiesales,
...
d3.json("../../resources/zipboundaries.json").then(function(data) {
  console.log(data);
  L.geoJSON(data, {
    color: "#0000FF",
    fillColor: "#FFFF00",
